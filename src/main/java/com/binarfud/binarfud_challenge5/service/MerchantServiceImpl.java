...
public class MerchantServiceImpl implements  MerchantService {
    ...
    public Boolean checkMerchantNameAvailability(MerchantDTO merchantDTO) {
        ...
        if (merchantDTOOptional.isPresent()) {
            ...
            return merchantRepository.existsByMerchantName(merchantDTO.getMerchantName());
        } else {
    ...
    public void addMerchant(MerchantDTO merchantDTO) throws IllegalArgumentException {
        ...
        if (merchantDTOOptional.isPresent()) {
            ...
            if (merchantNameOptional.isPresent() && merchantLocationOptional.isPresent() && merchantStatusOptional.isPresent()) {
                merchantRepository.save(convertMerchantDTOToMerchant(merchantDTO));
